$(document).ready(function () {
    ...
    var mouseMove = function (e) {
        ...
        if (e.pageX || e.pageY) {
            ...
            mouse.x = e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft - magnify_offset.left;
            mouse.y = e.clientY + document.body.scrollTop + document.documentElement.scrollTop - magnify_offset.top;
        }
